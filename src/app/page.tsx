            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">apekshalokhande8600@gmail.com</p>
                </div>
              </a>
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 text-gray-500">
              <a href="https://github.com/apekshaBL" target="_blank" rel="noopener noreferrer" className="hover:text-black">GitHub</a>
              <a href="https://www.linkedin.com/in/apekshalokhande/" target="_blank" rel="noopener noreferrer" className="hover:text-black">LinkedIn</a>
            </div>
          </div>
          <div className="mt-6 pt-6 border-t text-center text-gray-500">
            <p>&copy; 2025 MysteryMsg. Built by Apeksha Lokhande to showcase full-stack development skills.</p>
          </div>
        </div>
      </footer>
    </div>
